...
if (iDataSet == 1)                                % Training
 ...
 elseif (iSlope == 2) 
   alpha = 4 + 3*sin(x/100) + cos(sqrt(2)*x/50);    % You may modify this!
 elseif (iSlope == 3) 
   alpha = 4 + 2*sin(x/75) + cos(sqrt(2)*x/50);    % You may modify this!
 elseif (iSlope == 4) 
   alpha = 8 + sin(x/10) + 3*cos(sqrt(2)*x/100);    % You may modify this!
 elseif (iSlope == 5) 
   alpha = 2 + sin(x/10) + cos(sqrt(2)*x/50);    % You may modify this!
 elseif (iSlope == 6) 
   alpha = 4 + sin(x/10) + 2*cos(2*sqrt(2)*x/75);    % You may modify this!
 elseif (iSlope == 7) 
   alpha = 2 + sin(x/100) + cos(sqrt(2)*x/50);    % You may modify this!
 elseif (iSlope == 8) 
   alpha = 2 + sin(x/100) + cos(sqrt(5)*x/50);    % You may modify this!
 elseif (iSlope == 9) 
   alpha = 1.5 + sin(x/100) + 1/2 *cos(sqrt(10)*x/50);    % You may modify this!
 %% 
...
elseif (iDataSet == 2)                            % Validation
 ...
 elseif (iSlope == 2) 
   alpha = 3 + 2*sin(x/50) + cos(sqrt(5)*x/50);    % You may modify this!
 elseif (iSlope == 3) 
   alpha = 2 + sin(x/50) + cos(x/10);    % You may modify this!
 elseif (iSlope == 4) 
   alpha = 1 + 3*sin(x/1000) + cos(sqrt(5)*x/50);    % You may modify this!
 %% 
